var BigaReflejante = function(webGL, ancho, alto, largo, textura, repeticionTextura, mapaNormales, material)
{
	var prisma;
	...
	function inicializar()
	{
		...
		prisma = new PrismaRectangular(webGL, ancho, alto, largo, null, null, programasShader['difusoMapaNormalesReflejo']);
